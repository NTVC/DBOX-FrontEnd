(function() {
     ...
     * @type {boolean}
     */
    Nav.prototype.isMouseEnable = false;
     ...
     * @type {boolean}
     */
    Nav.prototype.mouseEnableTimeout = false;
    ...
    Nav.prototype._prevElement = null;
    ...
    Nav.prototype.changeScope = function (scopeName) {
        ...
        if(!scope){
            //throw new Error(scopeName+': Scope not found');
            return null;
        }
    ...
    Nav.prototype.getPrevElementWith = function ( _att ) {
        if(!this._prevElement){
            return false;
        }

        return this._prevElement.attr(_att);
    };
    ...
    Nav.prototype.onKeyUp = function() { keyIsPressed=true; }
    ...
    Nav.prototype.onkeyDown = function(event) {
        ...
        if (keyIsPressed){
            ...
            Nav.prototype._prevElement = $(Nav.instance._currentScope.currentElement);

            keyIsPressed=false;

            event.preventDefault();
            event.stopPropagation();//REVER ISSO DEPOIS
